...
var file_gokeeper_proto_rawDesc = []byte{
	0x0a, 0x0e, 0x67, 0x6f, 0x6b, 0x65, 0x65, 0x70, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x12, 0x0c, 0x6b, 0x69, 0x6d, 0x2e, 0x67, 0x6f, 0x6b, 0x65, 0x65, 0x70, 0x65, 0x72, 0x22, 0x40,
	...
	,
...
var (
	...
	file_gokeeper_proto_rawDescData = file_gokeeper_proto_rawDesc
)

func file_gokeeper_proto_rawDescGZIP() []byte {
	file_gokeeper_proto_rawDescOnce.Do(func() {
		file_gokeeper_proto_rawDescData = protoimpl.X.CompressGZIP(file_gokeeper_proto_rawDescData)
	})
	return file_gokeeper_proto_rawDescData
}

var file_gokeeper_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_gokeeper_proto_goTypes = []interface{}{
	(*LoginRequest)(nil),     // 0: kim.gokeeper.LoginRequest
	(*LoginResponse)(nil),    // 1: kim.gokeeper.LoginResponse
	(*RegisterRequest)(nil),  // 2: kim.gokeeper.RegisterRequest
	(*RegisterResponse)(nil), // 3: kim.gokeeper.RegisterResponse
}
var file_gokeeper_proto_depIdxs = []int32{
	0, // 0: kim.gokeeper.UserService.Login:input_type -> kim.gokeeper.LoginRequest
	2, // 1: kim.gokeeper.UserService.Register:input_type -> kim.gokeeper.RegisterRequest
	1, // 2: kim.gokeeper.UserService.Login:output_type -> kim.gokeeper.LoginResponse
	3, // 3: kim.gokeeper.UserService.Register:output_type -> kim.gokeeper.RegisterResponse
...
func file_gokeeper_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_gokeeper_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gokeeper_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gokeeper_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gokeeper_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_gokeeper_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_gokeeper_proto_rawDesc = nil
